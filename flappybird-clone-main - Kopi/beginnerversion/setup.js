...
const fireballHitboxRadius = 120;
const fireballSpawnInterval = 2200;
let fireballXSpeed = randomBetween (-15,-25,5);
...
// Fjer variables
const FjerSound = coinSound;
const FjerImage = new Image(60, 60);
      FjerImage.src = "../assets/images/Fjer.png";
const FjerXSpeed = -7;
const FjerSpawnInterval = 2000;
const FjerValue = 1;
let FjerTimeSinceLastSpawn = FjerSpawnInterval
let Fjers = [];
