...
function updateDiamond() {
    ...
    for(let diamond of diamonds) {
        ...
        if(gameState == "action") {
            ...
            if(diamond.xPositionPosition < destructionXPosition) {
                diamonds = diamonds.remove(diamond);
            }
        }
...
function updateFjer() {
    for(let Fjer of Fjers) {
        Fjer.xPosition += FjerXSpeed;
        ...
        if(gameState == "action") {
            ...
            { // if they do, increase the score
                diamondSound.play();
                scoreValue += FjerValue;
                Fjers = Fjers.remove(Fjer);
            }
 
            if(Fjer.xPositionPosition < destructionXPosition) {
                Fjers = Fjers.remove(Fjer);
            }
        }
